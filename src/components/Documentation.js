...
`}
                ...
                <h4>Structure</h4>
                <p>Diamond consists of 3 main parts; the application layout, layout resources and theme resources for PrimeReact components. <i>App.js</i> inside app folder is the html
...
`}
                    ...
                    <h4>Theme</h4>
				    <p>Diamond provides 30 PrimeReact themes out of the box. Setup of a theme is simple by including the css of theme to your
...
`}
                    ...
                    <p>Variables of the light component theme, see the <a href="https://www.primefaces.org/designer/api/primereact/5.0.0/">Theme Designer API</a> for documentation.</p>
...
`}
                    ...
                    <h4>Menu Modes</h4>
                    <p>Menu has 3 modes, static, overlay and slim. Layout container element in App.js is used to define which mode to use by adding specific classes. List below indicates the style classes for each mode.</p>
                    <ul>
...
`}
                    ...
                    <h4>Grid CSS</h4>
                    <p>Diamond uses PrimeReact Flex Grid CSS throughout the demos such as Dashboard, however any Grid library can be used with it since Diamond Layout itself does not depend on PrimeFlex CSS.</p>
